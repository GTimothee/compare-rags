...
parser.add_argument('answers_filepath', type=str, help='The path to the JSON file containing answers generated by RAG.')
...
if __name__ == "__main__":
    ...
    with open(args.answers_filepath, 'r') as f:
        samples = json.load(f)
